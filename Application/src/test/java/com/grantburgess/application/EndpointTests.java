...
public class EndpointTests {
   ...
   // private final String PRICE = AMOUNT.toPlainString();
    ...
    private OfferViewModel buildOfferViewModel(String id, String name, String description, String startDate, String endDate, String status) {
    ...
    public void can_get_offer_by_id() throws Exception {
        String id = UUID.randomUUID().toString();
        OfferViewModel offerViewModel = buildOfferViewModel(id, NAME, DESCRIPTION, START_DATE, END_DATE, STATUS);
    ...
    public void can_get_offers() throws Exception {
        ...
        OfferViewModel offerViewModel2 = buildOfferViewModel(id2, "name-2", "", "2018-01-05", "2018-01-31", "EXPIRED");
    ...
    private class NewOfferRequest {
      ...
      //  private String currency;
       // private BigDecimal price;
        ...
        public NewOfferRequest(String name, String description, String startDate, String endDate) {
            this.name = name;
