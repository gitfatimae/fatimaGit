...
public class OffersPresenterTest {
   ...
   // private static final BigDecimal AMOUNT = BigDecimal.TEN;
    ...
    private void assertOfferViewModel(OffersViewModel viewModel, String id, String name, String description, String startDate, String endDate, String status) {
    ...
    public void can_present_offers() {
        ...
        OffersResponse responseModel = OffersResponse
                .builder()
                .addOffer(new OfferResponse(offerId1, offerName1, DESCRIPTION, START_DATE, END_DATE, STATUS))
                .addOffer(new OfferResponse(offerId2, offerName2, "", START_DATE.plusDays(1), END_DATE, OfferResponse.Status.EXPIRED))
                .build();
        // WHEN
        ...
        assertOfferViewModel(viewModel, offerId1.toString(), offerName1, DESCRIPTION, "2018-01-01", "2018-01-31", STATUS.name());
        assertOfferViewModel(viewModel, offerId2.toString(), offerName2, "", "2018-01-02", "2018-01-31", "EXPIRED");
    }
}