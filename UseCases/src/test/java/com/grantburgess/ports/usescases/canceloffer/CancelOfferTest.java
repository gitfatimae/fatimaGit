...
public class CancelOfferTest {
    ...
    public void setUp() {
        ...
        offer = new Task(
                ...
                OFFER_START_DATE,
                OFFER_END_DATE
             //   new Task.Money("GBP", BigDecimal.TEN)
        );
    }
    ...
    public void cannot_cancel_offer_that_is_already_cancelled() {
        ...
        Task offer2 = database.offerGateway().getByIdExcludingCancelled(offerId);
    ...
    public void can_cancel_offer() {
        ...
        // THEN
        Task cancelledOffer = database.offerGateway().getByIdExcludingCancelled(offerId);
