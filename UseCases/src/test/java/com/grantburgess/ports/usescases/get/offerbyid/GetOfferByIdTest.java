...
public class GetOfferByIdTest {
   ...
   // private static final Task.Money OFFER_PRICE = new Task.Money(OFFER_PRICE_CURRENCY, OFFER_PRICE_AMOUNT);
    ...
    public void can_get_expired_offer_by_id() {
        ...
        UUID offerId = database.offerGateway().add(new Task(OFFER_NAME, OFFER_DESCRIPTION, OFFER_START_DATE, expiredEndDate));
    ...
    public void cannot_get_cancelled_offer() {
        // GIVEN
        UUID offerId = database.offerGateway().add(new Task(OFFER_NAME, OFFER_DESCRIPTION, OFFER_START_DATE, OFFER_END_DATE));
        Task offer = database.offerGateway().getByIdExcludingCancelled(offerId);
